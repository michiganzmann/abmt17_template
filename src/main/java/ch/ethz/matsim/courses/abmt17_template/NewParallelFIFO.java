...
import ch.ethz.matsim.av.electric.assets.station.StationSpecification;
...
public class NewParallelFIFO implements Station, StationQueue {
	...
	public NewParallelFIFO(Id<Station> id, Link link, ParallelFIFOSpecification specification, ConsumptionTracker tracker, EventsManager events) {
		this.id = id;
		this.link = link;
	...
	public int getRechargingVehicles() {
		return rechargingVehicles.size();
	}
	public int getFinishedVehicles() {
		return finishedVehicles.size();
	}
}
